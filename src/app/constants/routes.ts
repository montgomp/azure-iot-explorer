...
export enum ROUTE_PARTS {
    ...
    MODULE_DIGITAL_TWINS_COMPONENTS = 'moduleDigitalTwinsComponents',
    MODULE_DIGITAL_TWINS_MODEL = 'moduleDigitalTwinsModel',
    MODULE_DIGITAL_TWINS_TWIN = 'moduleDigitalTwinsTwin',
