...
export const ModuleIdentityDetailHeader: React.FC = () => {
    ...
    const NAV_LINK_ITEMS = [
        ROUTE_PARTS.MODULE_DETAIL,
        ROUTE_PARTS.MODULE_TWIN,
        ROUTE_PARTS.MODULE_METHOD,
        ROUTE_PARTS.MODULE_DIGITAL_TWINS_COMPONENTS,
        ROUTE_PARTS.MODULE_DIGITAL_TWINS_MODEL,
        ROUTE_PARTS.MODULE_DIGITAL_TWINS_TWIN
    ];
